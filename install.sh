...
case $arch in
    x86_64 | amd64 | x86_64h)
        ...
        arquivo_ssh="https://raw.githubusercontent.com/UlekBR/SshManagerApiTests/main/sshmanager"
        ;;
    aarch64 | arm64 | armv8-a)
        echo "Sistema baseado em arm64 (64-bit ARM)"
        arquivo_ssh="https://raw.githubusercontent.com/UlekBR/SshManagerApiTests/main/sshmanagerarm"
        ;;
    *)
